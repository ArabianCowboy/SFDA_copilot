...
| `chatbot_settings`     | 0                             | Unused. Not read or written by any code. Carried the full default ACL — every privilege for `anon` and `authenticated`, `TRUNCATE` included — until `20260828001058` revoked it; the table was created through the dashboard before the migration discipline existed, and it is the receipt for what every table looked like before `20260828000737` closed the default. Whether it is dropped or finally used is still open in `TODO.md`.                                                                                                                                                                                                              |
