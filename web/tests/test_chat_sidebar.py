...
def test_the_open_conversation_is_marked_active(browser_page: Page):
    ...
    question joins. It comes from the URL now (docs/ARCHITECTURE.md#the-url-is-the-pointer;
    reasoning in docs/archive/2026-08-22_per-tab-deep-linking.md §4.1) rather than the server's
