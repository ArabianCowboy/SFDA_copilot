...
ICONS: dict[str, str] = {
    ...
    "bell": (
        ...
        "12 6a4 4 0 0 0-3.203-3.92zM14.22 12c.223.447.481.801.78 1H1c.299"
        "-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 "
        "4.005-4.901a1 1 0 1 1 1.99 0A5 5 0 0 1 13 6c0 .88.32 4.2 1.22 "
        '6"/>'
    ),
    "trash": (
...
RUNTIME_ICON_NAMES: tuple[str, ...] = (
    ...
    "trash",
    "check",
    # The Notification Center bell + inbox modal (built in JS, dom.js/ui.js).
    "bell",
...
def icon(name: str, size: int = 16, cls: str = "", title: str = "") -> Markup:
    ...
    try:
        ...
        raise KeyError(f"unknown icon {name!r}; add it to web/utils/icons.py") from None
